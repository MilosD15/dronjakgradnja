...
main .services .electrican_works .text, \
main .services .additional .text, \
main .start, main #why_sec, \
main #contact_sec, footer");
        ...
        if(entry.isIntersecting) {
            ...
            if(entry.target.id == "beginning") {
                ...
                if(window.innerWidth > 1000) {
                    ...
                    contactBtn.style.animation = "slideRight 1s ease 0.3s forwards";
                    whyBtn.style.animation = "slideRight 1s ease 0.3s forwards";
                    aboutBtn.style.animation = "slideRight 1s ease 0.3s forwards";
                    slider.style.animation = "slideLeft 1s ease 0.3s forwards";
                }
                if(window.innerWidth <= 1000 && window.innerWidth > 800) {
                    introMessage.style.animation = "slideRight 1s ease 0.3s forwards";
                    contactBtn.style.animation = "slideRight 1s ease 0.3s forwards";
                    if(html.lang == "nl") whyBtn.style.animation = "slideRight 1s ease 0.3s forwards";
                    if(html.lang == "en" || html.lang == "sr") whyBtn.style.animation = "slideRightWhy 1s ease 0.3s forwards";
                    aboutBtn.style.animation = "slideRight 1s ease 0.3s forwards";
                    slider.style.animation = "slideLeft 1s ease 0.3s forwards";
                }
                ...
                if(window.innerWidth <= 630 && window.innerWidth > 530) {
                    ...
                    if(html.lang == "nl") {
                        ...
                        if(window.innerWidth <= 580 && window.innerWidth > 530) {
                            contactBtn.style.animation = "slideRightMessage 1s ease 0.3s forwards";
                            whyBtn.style.animation = "slideRightMessage 1s ease 0.3s forwards";
                            aboutBtn.style.animation = "slideRightMessage 1s ease 0.3s forwards";
                        }
                    } else {
                        contactBtn.style.animation = "slideRight 1s ease 0.3s forwards";
                        whyBtn.style.animation = "slideRight 1s ease 0.3s forwards";
                        aboutBtn.style.animation = "slideRightStart 1s ease 0.3s forwards";
                    }
                    slider.style.animation = "slideLeftStart 1s ease 0.3s forwards";
                }
            ...
            if(entry.target.id == "EW") {
                const h1 = document.querySelector("main .services .electrican_works .text .wrapper h1");
                const ul = document.querySelector("main .services .electrican_works .text .wrapper ul");
                const li1 = document.querySelector("main .services .electrican_works .text .wrapper ul .first-li");
                const li2 = document.querySelector("main .services .electrican_works .text .wrapper ul .second-li");
                const li3 = document.querySelector("main .services .electrican_works .text .wrapper ul .third-li");
                const slider = document.querySelector("main .services .electrican_works .images .electrican_slider");
            ...
            if(entry.target.id == "contact_sec") {
                const h1 = document.querySelector("main #contact_sec h1");
                const p = document.querySelector("main #contact_sec p");
                const email = document.querySelector("main #contact_sec .row .first-hr");
                const subject = document.querySelector("main #contact_sec .row .second-hr");
                const message = document.querySelector("main #contact_sec .row .whole-row");
                const button = document.querySelector("main #contact_sec .row button");
                h1.style.animation = "slideRight 1s ease forwards";
